...
[**시스템** > 2:제어 파라미터 > 7:프로그램 예약 실행] 항목에서 '적용 레지스터 개수'를 20개 또는 1개로 선택합니다. 
...
* 프로그램 예약 실행에 대한 자세한 내용은 별도의 “[Hi6/Hi7 제어기 프로그램 예약 실행 기능 설명서](https://hrbook-hrc.web.app/#/view/doc-reserved-program-execution/korean/README)”를 참조하십시오.
{% endhint %}
