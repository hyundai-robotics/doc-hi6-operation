...
![그림 41 범용 출력 신호 - ON/OFF 상태\(좌\) / 값 상태\(우\)](../_assets/image%20%28152%29.png)
...
![](../_assets/image%20%28157%29.png)

1. 수동 출력 확인창에서 출력 조건을 확인한 후 \[확인\] 버튼을 터치하십시오.

![](../_assets/image%20%28147%29.png)
