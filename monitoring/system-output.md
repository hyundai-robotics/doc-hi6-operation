...
![그림 38 시스템 출력 - ON/OFF 상태\(좌\) / 값 상태\(우\)](../_assets/image%20%28159%29.png)

![그림 39 시스템 출력 - 시퀀스 상태](../_assets/image%20%28161%29.png)
...
![](../_assets/image%20%28146%29.png)

1. 수동 출력 확인창에서 출력 조건을 확인한 후 \[확인\] 버튼을 터치하십시오.

![](../_assets/image%20%28143%29.png)
