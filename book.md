...
값 열을 선택하고 ENTER키를 누르거나 [F6: 하위레벨] 버튼을 클릭하면 배열이 하위레벨로 펼쳐지면서 요소 값들을 볼 수 있습니다.  
...
[F5: 상위레벨] 버튼을 클릭하거나 ESC키를 누르면 다시 상위레벨로 올라갑니다.
...
![](../../_assets/tp630/panel-gvar/fixed-var.png)# 6.9 지역변수
