...
{% hint style="info" %}
Hi6 티치 펜던트의 사용자키 영역에서도 동일한 설정화면에 진입할 수 있습니다. 자세한 내용은 "[2.7.2.1 키 신호 출력 기능 영역](../../../2-operation/7-user-key/2-button-registration/1-key-signal-output.md)"를 참조하십시오.
{% endhint %}
