...
4. 로봇은 고정된 상태에서 베이스 축만 움직여 위치를 측정하고 위치를 프로그램으로 기록하십시오. 
    ...
    * 또한, 하나의 축 당 기록위치가 50점을 초과하거나 전체 기록 위치가 100점을 초과할 수 없습니다.
...
- [gather](https://hrbook-hrc.web.app/#/view/doc-hrscript/ko/10-etc/1-proc/1-gather?cont_model=Hi6) 문을 이용해서 데이터 수집을 할 수 있습니다.
