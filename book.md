...
# 7.3.10.1 옵션기능의 라이센스키란?

Hi6 로봇 제어기의 기능들 중 특정 옵션기능들은 별도로 판매하고 있으며, 고객께서는 옵션기능을 구매해야 사용할 수 있습니다. 옵션기능의 라이선스키는 로봇제어기의 메인보드에 부여된 고유번호와 구매한 옵션기능을 조합하여 별도의 라이센스키 생성 프로그램에 의해 만들어지기 때문에 구매한 제어기에서만 구매한 기능이 동작하도록 되어 있습니다.
