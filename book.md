...
{% hint style="info" %}
\[**시스템** &gt; 제어 파라미터 &gt; 입출력 신호 설정 &gt; 키 신호 출력\] 메뉴에서도 원하는 출력 신호를 키 신호 출력 기능 영역의 버튼에 할당할 수 있습니다. 자세한 내용은 “[7.3.2.8 키 신호 출력](../../../../)”를 참조하세요.
{% endhint %}
...
수동 모드에서 사용합니다. 모터가 켜진 상태에서 인에이블링 스위치를 잡고 있는 동안 티치 펜던트의 <<b>ENTER</b>>, <**ESC**> 및 &lt;←/→&gt; 키와 숫자키는 ‘조그키’로 동작합니다.
...
2.	티치 펜던트의 &lt;↓/↑&gt; 키로 원하는 행에 커서를 두고 <<b>ENTER</b>> 키를 누르십시오. 커서가 위치한 행이 블록의 시작행으로 선택됩니다. 
