...
1. 시스템 프로그램의 설치
    ...
    * \[[5: 파일관리](2-file-manager/README.md)\] 메뉴를 실행하고 \[<img src="../_assets/icon-usb.png" alt/>USB\] 파일 목록 에서 해당 파일을 더블클릭 합니다.
...
⛔ **특수한 경우를 제외하고, 슈퍼바이저 모드에서 부가축 자동튜닝 사용은 제한됩니다.**
