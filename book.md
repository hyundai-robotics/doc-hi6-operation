...
* 작업 영역의 패널 스택과 창의 사용 방법에 대한 자세한 내용은 "[1.2.3.8 작업 편집창](../1-robot-system/2-basic-usage/3-screen-of-the-hi6-tp/8-work-area?cont_model=${cont_model})"을 참조하십시오.
{% endhint %}
...
시작 인덱스 편집박스에 값을 입력하여 특정 배열 요소부터 표시하도록 할 수 있습니다. ([전역변수](8-global-variable/README?cont_model=${cont_model}) 창과 조작방법이 동일합니다.)
