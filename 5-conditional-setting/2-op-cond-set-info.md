...
* \[10: PLC 동작 모드\]: 로봇 제어기가 내장 PLC를 사용하여 입출력 신호를 제어할 때, 내장 PLC를 제어하기 위한 모드를 설정합니다. 내장 PLC 모드는 모두 4가지가 있습니다. 자세한 내용은 "[Hi6/Hi7 제어기 내장 PLC 기능설명서](https://hrbook-hrc.web.app/#/view/doc-hi6-embedded-plc/korean/README)"를 참고 하십시오.
