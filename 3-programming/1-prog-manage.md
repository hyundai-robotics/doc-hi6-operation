...
* 새 프로그램을 추가하려면, 신규 프로그램 번호를 입력 후 엔터를 입력하십시오. “3.2 프로그램 작성”을 참조하여 내용을 입력하십시오.
...
* 프로그램을 삭제하려면, 파일 목록\(\[메뉴 &gt; 5: 파일관리\]\)에서 해당 프로그램을 선택한 후 삭제하십시오. 자세한 내용은 "[4.2.1 파일관리](../4-menu/2-file-manager/1-file-management.md)"를 참고하시기 바랍니다.
