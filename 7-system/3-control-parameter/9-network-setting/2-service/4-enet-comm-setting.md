...
현재는 HRScript에서 모드버스 마스터 동작을 수행하기 위해 사용됩니다. 모드버스 통신 기능에 대한 자세한 내용은 별도의 [Hi6/Hi7 로봇제어기 기능설명서 - 모드버스](https://hrbook-hrc.web.app/#/view/doc-modbus/korean/README)를 참조하십시오.  
