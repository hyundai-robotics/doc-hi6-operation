...
* 시스템을 초기화하면 제어 파라미터 파일, 기계 파라미터 파일을 포함한 모든 데이터와 프로그램이 삭제됩니다. 시스템을 초기화하기 전에 데이터를 백업해 두면 필요한 경우 복원하여 사용할 수 있습니다. 데이터 백업과 복원에 대한 자세한 내용은 “[4.2.5 데이터 백업](../../4-menu/4-2-file-manager/data-backup.md)”과 “[4.2.6 데이터 복원](../../4-menu/4-2-file-manager/data-restore.md)”을 참조하십시오.
{% endhint %}
