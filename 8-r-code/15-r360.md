...
CONTPATH(연속패스) 모드를 수동으로 변경하는 기능입니다. 입력범위는 0, 1, 2 이고, 각 번호 별 설명은 다음과 같습니다. ([contpath](https://hrbook-hrc.web.app/#/view/doc-hrscript/korean-${cont_model}/5-moving-robot/6-contpath) 명령문과 동일)
