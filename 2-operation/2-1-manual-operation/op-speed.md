...
![](../../.gitbook/assets/lbt-spd-bar%20%281%29.png)
...
조그 속도 레벨\(1: 저속~8: 고속\)을 설정하려면, 원하는 속도 레벨이 나타날 때까지 \[![](../../.gitbook/assets/bt-spd-up.png)/![](../../.gitbook/assets/bt-spd-dn.png)\] 버튼을 반복하여 터치하십시오. 조그 속도 레벨은 \[![](../../.gitbook/assets/bt-spd-up.png)/![](../../.gitbook/assets/bt-spd-dn.png)\] 버튼 사이에 숫자로 표시됩니다. 이 때에도 로봇 툴과 링크의 최고 속도는 제한 속도 이하로 제한됩니다.
