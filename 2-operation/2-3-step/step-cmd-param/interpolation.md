...
로봇이 작업물을 소유하고, 외부의 고정된 툴을 이용하여 작업하는 경우에 사용합니다. 이 경우에 보간 동작은 로봇이 소유하고 있는 작업물을 기준으로 이루어집니다.  정치툴 보간의 종류에 대한 자세한 내용은 “[7.3.6.2 정치툴 좌표계](../../../7-setting/7-3-control-parameter/cordsys-reg/stationary-tool-crdsys.md)”를 참조하십시오.
