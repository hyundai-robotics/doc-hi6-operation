...
4.	초기 화면의 좌측에서 \[속도조절\] 버튼을 터치하십시오. 조건 설정창이 나타납니다.
...
	\[6: 자동운전 속도비율\]: 자동 모드에서 프로그램 재생 시 로봇의 운전 속도\(%\)를 설정합니다.

예를 들어, 운전 속도를 100으로 설정하면 스텝의 기록 속도로 로봇이 이동하고 50으로 설정하면 기록 속도의 50% 비율로 로봇이 이동합니다.
